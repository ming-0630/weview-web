...
const ProductCardV1 = (props: ProductCardProps) => {
    ...
    return (
        <div className={classNames('text-gray-dark w-full rounded-xl flex flex-col hover:scale-105 transition cursor-pointer rounded-2xl overflow-hidden',
            'bg-gradient-to-t from-main to-white-plain to-40% drop-shadow-xl',
            props.hasBorder && ''
        )}>
